      ...
      <a-tabs type="card">
        <a-tab-pane key="1" type="card">
          ...
          <a-radio-group v-model="result.second.cronEvery">
            ...
            <a-row>
              <a-radio value="2">每隔
                <a-input-number v-model="result.second.incrementIncrement" size="small" :min="1" :max="59" />
                秒执行 从
            ...
            <a-row>
              <a-radio value="4">周期从
                <a-input-number v-model="result.second.rangeStart" size="small" :min="1" :max="59" />
                到
