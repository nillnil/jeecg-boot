<template>
  <div ref="dragDiv" class="drag">
    ...
    <div ref="moveDiv" :class="{'handler_ok_bg':confirmSuccess}" class="handler handler_bg" style="border: 0.5px solid #fff;height: 34px;position: absolute;top: 0px;left: 0px;" @mousedown="mousedownFn($event)" />
  </div>
</template>
