  ...
  <a-card :bordered="false">
    <a-tabs default-active-key="1">
      ...
      <a-tab-pane key="1" tab="柱状图">
        <bar title="销售额排行" :data-source="barData" :height="height" />
      </a-tab-pane>
      <!-- 多列柱状图 -->
      ...
      <a-tab-pane key="3" tab="迷你柱状图">
        <mini-bar :data-source="barData" :width="400" :height="200" />
      </a-tab-pane>
      <!-- 面积图 -->
      <a-tab-pane key="4" tab="面积图">
        <area-chart-ty title="销售额排行" :data-source="areaData" x="月份" y="销售额" :height="height" />
      </a-tab-pane>
      <!-- 迷你面积图 -->
      <a-tab-pane key="5" tab="迷你面积图">
        <div style="padding-top: 100px;width:600px;height:200px">
          <mini-area :data-source="areaData" x="月份" y="销售额" :height="height" />
        </div>
      </a-tab-pane>
      <!-- 多行折线图 -->
