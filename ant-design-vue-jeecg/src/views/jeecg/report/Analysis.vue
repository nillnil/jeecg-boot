    ...
    <a-row :gutter="24">
      ...
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="用户受理量" :total="cardCount.isll | NumberFormat">
          ...
          <div>
            <mini-bar :data-source="chartData.isll" />
          </div>
      ...
      <a-col :sm="24" :md="12" :xl="6" :style="{ marginBottom: '24px' }">
        <chart-card :loading="loading" title="用户办结量" :total="cardCount.ibjl | NumberFormat">
          ...
          <div>
            <mini-bar :data-source="chartData.ibjl" />
          </div>
      ...
      <div class="salesCard">
        <a-tabs default-active-key="1" size="large" :tab-bar-style="{marginBottom: '24px', paddingLeft: '16px'}">
                  ...
                  <div class="item-group">
                    <a-row>
                      <a-col v-for="(item,index) in registerTypeList" :key=" 'registerType'+index " :class="'more-btn'" :span="12">
                        <a-button style="margin-bottom:10px" size="small" type="primary" ghost @click="goPage(index)">{{ item.text }}</a-button>
                      </a-col>
                    </a-row>
                  </div>
                </a-card>
          ...
          <a-tab-pane key="2" tab="交互监管">
            <a-row>
              <a-col :xl="16" :lg="12" :md="12" :sm="24" :xs="24">
                <bar-multid :data-source="jhjgData" :fields="jhjgFields" title="平台与部门交互量统计" />
              </a-col>
              <a-col :xl="8" :lg="12" :md="12" :sm="24" :xs="24">
          ...
          <a-tab-pane key="3" tab="效率监管">
            <a-row>
              <a-col :xl="16" :lg="12" :md="12" :sm="24" :xs="24">
                <line-chart-multid :data-source="xljgData" :fields="xljgFields" title="平台与部门交互效率统计" />
              </a-col>
              <a-col :xl="8" :lg="12" :md="12" :sm="24" :xs="24">
                ...
                <a-row>
                  <template v-if="diskInfo && diskInfo.length>0">
                    <a-col v-for="(item,index) in diskInfo" :key=" 'diskInfo'+index " :span="12">
                      <dash-chart-demo :title="item.name" :data-source="item.restPPT" />
                    </a-col>
                  </template>
                </a-row>
              </a-col>
