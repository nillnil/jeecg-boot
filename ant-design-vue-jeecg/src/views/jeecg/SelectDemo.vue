    ...
    <div class="table-page-search-wrapper">
      <a-form layout="inline" :form="form">
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="性别">
              <j-dict-select-tag v-model="formData.sex" title="性别" dict-code="sex" />
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="字典表下拉">
              <j-dict-select-tag v-model="formData.user" placeholder="请选择用户" dict-code="sys_user,realname,id" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="字典表下拉(带条件)">
              <j-dict-select-tag v-model="formData.user2" placeholder="请选择用户" dict-code="sys_user,realname,id,username!='admin' order by create_time" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="选择部门 自定义返回值">
              <j-select-depart v-decorator="['departId']" :trigger-change="true" custom-return-field="departName" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="选择部门">
              <j-select-depart v-model="departId" :multi="true" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="选择用户">
              <j-select-user-by-dep v-model="userIds" :multi="true" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="选择用户">
              <j-select-multi-user v-model="multiUser" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="日期选择框">
              <j-date v-model="jdate.value" :show-time="true" date-format="YYYY-MM-DD HH:mm:ss" />
            </a-form-item>
          </a-col>
        ...
        <a-row :gutter="24">
          <a-col :span="12">
            <a-form-item label="cron表达式">
              <j-cron ref="innerVueCron" v-decorator="['cronExpression', { initialValue: '* * * * * ? *' }]" @change="setCorn" />
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
...
sayHi('hello, world!')`
  ...
  methods: {
    ...
    handleClickToggleFullScreen() {
      const mode = !this.modal.fullScreen
      if (mode) {
