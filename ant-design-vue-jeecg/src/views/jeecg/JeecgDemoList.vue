        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="用户名">
              <j-input v-model="queryParam.name" placeholder="请输入名称模糊查询" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="年龄">
              <!-- <a-input placeholder="请输入名称查询" v-model="queryParam.age"></a-input>-->
              <a-input v-model="queryParam.age_begin" placeholder="最小年龄" type="ge" style="width:calc(50% - 15px);" />
              <span class="group-query-strig">~</span>
              <a-input v-model="queryParam.age_end" placeholder="最大年龄" type="le" style="width:calc(50% - 15px);" />
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            ...
            <a-col :md="6" :sm="8">
              <a-form-item label="性别">
                <j-dict-select-tag v-model="queryParam.sex" placeholder="请选择性别" dict-code="sex" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="选择用户">
                <j-dict-select-tag v-model="queryParam.id" placeholder="请选择用户" dict-code="demo,name,id" />
              </a-form-item>
            </a-col>
          </template>
...
-->
            <!-- 高级查询区域 -->
            <j-super-query ref="superQueryModal" :field-list="fieldList" @handleSuperQuery="handleSuperQuery" />
    ...
    <!-- 表单区域 -->
    <jeecgDemo-modal ref="modalForm" @ok="modalFormOk" />

    <!-- 一对多表单区域 -->
    <JeecgDemoTabsModal ref="jeecgDemoTabsModal" @ok="modalFormOk" />
