  ...
  >
    ...
    <a-spin :spinning="confirmLoading">
        ...
        <a-row class="form-row" :gutter="0">
          ...
          <a-col :lg="8">
            <a-form-item
              ...
              label="订单类型"
            >
              <a-select v-decorator="['ctype',{}]" placeholder="请选择订单类型">
          ...
          <a-col :lg="8">
            <a-form-item
              ...
              label="订单日期"
            >
              <a-date-picker v-decorator="[ 'orderDate',{}]" show-time format="YYYY-MM-DD HH:mm:ss" style="width: 100%" />
            </a-form-item>
          </a-col>
        </a-row>
        <a-row class="form-row" :gutter="0">
          <a-col :lg="8">
            <a-form-item
              ...
              label="订单金额"
            >
              <a-input-number v-decorator="[ 'orderMoney', {}]" placeholder="请输入订单金额" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :lg="8">
            <a-form-item
      ...
      <a-tabs v-model="activeKey" @change="handleChangeTabs">
        <a-tab-pane key="1" tab="客户信息" :force-render="true">

          <j-editable-table
            ref="editableTable1"
            :loading="table1.loading"
            :columns="table1.columns"
            :data-source="table1.dataSource"
            :max-height="300"
            :row-number="true"
            :row-selection="true"
            :action-button="true"
        ...
        <a-tab-pane key="2" tab="机票信息" :force-render="true">
