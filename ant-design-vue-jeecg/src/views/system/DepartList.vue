    ...
    <a-col :md="12" :sm="24">
      <a-card :bordered="false">
        ...
        <a-row style="margin-left: 14px">
          <a-button type="primary" @click="handleAdd(2)">添加子部门</a-button>
          <a-button type="primary" @click="handleAdd(1)">添加一级部门</a-button>
      ...
      <a-card :bordered="false">
        <a-form :form="form">
          <a-form-item
            ...
            label="机构名称"
          >
            <a-input v-decorator="['departName', validatorRules.departName ]" placeholder="请输入机构/部门名称" />
          </a-form-item>
          ...
          <a-form-item
            ...
            label="机构编码"
          >
            <a-input v-decorator="['orgCode', validatorRules.orgCode ]" disabled placeholder="请输入机构编码" />
          </a-form-item>
          <a-form-item
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
          ...
          <a-form-item
            ...
            label="手机号"
          >
            <a-input v-decorator="['mobile', {'initialValue':''}]" placeholder="请输入手机号" />
          </a-form-item>
          <a-form-item
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            label="地址"
          >
            <a-input v-decorator="['address', {'initialValue':''}]" placeholder="请输入地址" />
          </a-form-item>
          <a-form-item
            :label-col="labelCol"
            :wrapper-col="wrapperCol"
            label="备注"
          >
            <a-textarea v-decorator="['memo', {'initialValue':''}]" placeholder="请输入备注" />
          </a-form-item>
        </a-form>
        <div class="anty-form-btn">
          <a-button type="default" html-type="button" icon="sync" @click="emptyCurrForm">重置</a-button>
          <a-button type="primary" html-type="button" icon="form" @click="submitCurrForm">修改并保存</a-button>
        </div>
      </a-card>
    </a-col>
    <depart-modal ref="departModal" @ok="loadTree" />
  </a-row>
</template>
<script>
