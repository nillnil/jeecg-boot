        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="搜索日志">
              <a-input v-model="queryParam.keyWord" placeholder="请输入搜索关键词" />
            </a-form-item>
          </a-col>
          ...
          <a-col v-if="tabKey === '2'" :md="5" :sm="8">
            <a-form-item label="操作类型" style="left: 10px">
              <j-dict-select-tag v-model="queryParam.operateType" placeholder="请选择操作类型" dict-code="operate_type" />
            </a-form-item>
          </a-col>
          ...
          <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
            <a-col :md="6" :sm="24">
              ...
              <a-button type="primary" icon="reload" style="margin-left: 8px;left: 10px" @click="searchReset">重置</a-button>
            </a-col>
          </span>
