    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="角色编码"
        >
          <a-input v-decorator="[ 'roleCode', validatorRules.roleCode]" placeholder="请输入角色编码" :disabled="roleDisabled" />
        </a-form-item>
        ...
        <a-form-item
          ...
          label="描述"
        >
          <a-textarea v-decorator="[ 'description', validatorRules.description ]" :rows="5" placeholder="..." />
        </a-form-item>
