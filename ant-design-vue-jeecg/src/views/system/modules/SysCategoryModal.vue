  ...
  >
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="父级节点" :label-col="labelCol" :wrapper-col="wrapperCol">
          <j-tree-select
            ref="treeSelect"
        ...
        <a-form-item label="类型名称" :label-col="labelCol" :wrapper-col="wrapperCol">
          <a-input v-decorator="[ 'name', validatorRules.name]" placeholder="请输入类型名称" />
        </a-form-item>
