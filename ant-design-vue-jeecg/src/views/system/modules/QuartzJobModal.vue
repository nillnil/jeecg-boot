    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          has-feedback
        >
          <a-input v-decorator="['jobClassName', {rules: [{ required: true, message: '请输入任务类名!' }]}]" placeholder="请输入任务类名" />
        </a-form-item>
        <a-form-item
          :label-col="labelCol"
          :wrapper-col="wrapperCol"
        ...
        <a-form-item
          ...
          label="参数"
        >
          <a-textarea v-decorator="['parameter', {}]" placeholder="请输入参数" :rows="5" />
        </a-form-item>
        <a-form-item
          :label-col="labelCol"
          :wrapper-col="wrapperCol"
          label="描述"
        >
          <a-textarea v-decorator="['description', {}]" placeholder="请输入描述" :rows="3" />
        </a-form-item>
        <a-form-item
          :label-col="labelCol"
          :wrapper-col="wrapperCol"
          label="状态"
        >
          <a-radio-group v-decorator="[ 'status', {'initialValue':0}]" button-style="solid">
