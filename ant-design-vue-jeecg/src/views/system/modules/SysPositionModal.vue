    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="职务编码"
        >
          <a-input v-decorator="['code', validatorRules.code]" placeholder="请输入职务编码" />
        </a-form-item>
        <a-form-item
          :label-col="labelCol"
          :wrapper-col="wrapperCol"
          label="职务名称"
        >
          <a-input v-decorator="['name', validatorRules.name]" placeholder="请输入职务名称" />
        </a-form-item>
        <a-form-item
          :label-col="labelCol"
          :wrapper-col="wrapperCol"
