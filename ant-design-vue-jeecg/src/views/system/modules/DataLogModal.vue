<template>
  <div>
    ...
    >
          ...
          <a-row class="form-row" :gutter="24">
            <a-col :md="12" :sm="8">
              <a-form-item label="数据库表名" :label-col="{ span: 6 }" :wrapper-col="{ span: 15 }">
                <a-input v-decorator="[ 'dataTale', {}]" placeholder="请输入数据库表名" disabled @blur="handleTableBlur" />
              </a-form-item>
            </a-col>

            <a-col :md="12" :sm="8">
              <a-form-item label="数据ID" :label-col="{ span: 5 }" :wrapper-col="{ span: 15 }">
                <a-input v-decorator="[ 'dataId', {}]" placeholder="请输入数据ID" disabled @blur="handleIdBlur" />
              </a-form-item>
            </a-col>
          </a-row>
      ...
      <data-log-compare-modal ref="modal" @ok="modalFormOk" />
    </a-modal>
  </div>
</template>
