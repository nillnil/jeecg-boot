    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          label="规则字段"
        >
          <a-input v-decorator="['ruleColumn', validatorRules.ruleColumn]" placeholder="请输入规则字段" />
        </a-form-item>
        <a-form-item
          :label-col="labelCol"
          :wrapper-col="wrapperCol"
          label="条件规则"
        >
          <j-dict-select-tag v-decorator="['ruleConditions', validatorRules.ruleConditions]" placeholder="请输入条件规则" :trigger-change="true" dict-code="rule_conditions" @change="handleChangeRuleCondition" />
        </a-form-item>
        <a-form-item
          :label-col="labelCol"
          :wrapper-col="wrapperCol"
          label="规则值"
        >
          <a-input v-decorator="['ruleValue', validatorRules.ruleValue]" placeholder="请输入规则值" />
        </a-form-item>
        ...
        <a-form-item
          ...
          label="状态"
        >
          <a-radio-group v-decorator="['status',{initialValue:'1'}]" button-style="solid">
