      ...
      <a-form :form="form">
        <a-row class="form-row" :gutter="{ xs: 8, sm: 16, md: 24, lg: 32 }">
          <a-col :lg="12">
            <a-form-item
              ...
              label="标题"
            >
              <a-input v-decorator="['titile', validatorRules.title]" placeholder="请输入标题" :read-only="disableSubmit" style="width: 90%" />
            </a-form-item>
          </a-col>
          <a-col :lg="12">
            <a-form-item
        ...
        <a-row class="form-row" :gutter="24">
          <a-col :lg="12">
            ...
            >
              <j-date v-decorator="[ 'startTime', validatorRules.startTime]" placeholder="请选择开始时间" show-time date-format="YYYY-MM-DD HH:mm:ss" />
            </a-form-item>
          </a-col>
          <a-col :lg="12">
            <a-form-item
              ...
              class="endTime"
            >
              <j-date v-decorator="[ 'endTime', validatorRules.endTime]" placeholder="请选择结束时间" show-time date-format="YYYY-MM-DD HH:mm:ss" />
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row>
          <a-col :lg="24" pull="3">
            ...
            >
              <j-editor v-decorator="[ 'msgContent', {} ]" style="width: 130%" trigger-change />
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
    </a-spin>
    <select-user-list-modal ref="UserListModal" @choseUser="choseUser" />
  </a-modal>
</template>
