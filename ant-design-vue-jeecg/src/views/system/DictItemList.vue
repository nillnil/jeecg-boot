            ...
            <a-row :gutter="10">
              <a-col :md="8" :sm="12">
                <a-form-item label="名称">
                  <a-input v-model="queryParam.itemText" style="width: 120px;" placeholder="请输入名称" />
                </a-form-item>
              </a-col>
              <a-col :md="9" :sm="24">
                <a-form-item label="状态" style="width: 170px" :label-col="labelCol" :wrapper-col="wrapperCol">
                  <a-select
