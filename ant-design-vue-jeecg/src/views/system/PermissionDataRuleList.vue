<template>
  ...
  >
    ...
    >
      <div class="table-page-search-wrapper">
        <a-form @keyup.enter.native="searchQuery">
          <a-row :gutter="12">
            <a-col :md="8" :sm="8">
              <a-form-item label="规则名称" :label-col="{span: 8}" :wrapper-col="{span: 14, offset: 1}">
                <a-input v-model="queryParam.ruleName" placeholder="请输入规则名称" />
              </a-form-item>
            </a-col>
            <a-col :md="8" :sm="8">
              <a-form-item label="规则值" :label-col="{span: 8}" :wrapper-col="{span: 14, offset: 1}">
                <a-input v-model="queryParam.ruleValue" placeholder="请输入规则值" />
              </a-form-item>
            </a-col>
            <a-col :md="7" :sm="8">
          ...
          <a-row>
            <a-col :md="24" :sm="24">
              <a-button style="margin-bottom: 10px" type="primary" icon="plus" @click="addPermissionRule">添加</a-button>
            </a-col>
          </a-row>
        </a-form>
    ...
    <permission-data-rule-modal ref="modalForm" @ok="modalFormOk" />
  </a-drawer>
</template>
<script>
