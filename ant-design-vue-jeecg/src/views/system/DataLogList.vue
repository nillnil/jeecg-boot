<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          <a-col :md="6" :sm="8">
            <a-form-item label="表名">
              <a-input v-model="queryParam.dataTable" placeholder="请输入表名" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="数据ID">
              <a-input v-model="queryParam.dataId" placeholder="请输入ID" />
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      <a-button type="primary" icon="plus" @click="handleCompare()">数据比较</a-button>
    </div>
    ...
    <data-log-modal ref="modalForm" @ok="modalFormOk" />
  </a-card>
</template>
