    ...
    <a-col :md="leftColMd" :sm="24" style="margin-bottom: 20px">
      <a-card :bordered="false">
        ...
        <div class="table-operator" style="margin: 5px 0 10px 2px">
          <a-button type="primary" icon="plus" @click="handleAdd">角色录入</a-button>
    ...
    <a-col v-if="rightcolval == 1" :md="rightColMd" :sm="24">
      <a-card :bordered="false">
            ...
            <a-row :gutter="24">
              ...
              <a-col :md="12" :sm="12">
                <a-form-item label="用户账号">
                  <a-input v-model="queryParam2.username" placeholder="" />
                </a-form-item>
              </a-col>
              <span style="float: left;overflow: hidden;" class="table-page-search-submitButtons">
                <a-col :md="9" :sm="24">
                  <a-button type="primary" icon="search" style="margin-left: 21px" @click="searchQuery2">查询</a-button>
                  <a-button type="primary" icon="reload" style="margin-left: 8px" @click="searchReset2">重置</a-button>
        ...
        <div class="table-operator" :md="24" :sm="24" style="margin: -25px 0px 10px 2px">
          <a-button type="primary" icon="plus" style="margin-top: 16px" @click="handleAdd2">用户录入</a-button>
          <!--<a-button @click="handleEdit2" type="primary" icon="edit" style="margin-top: 16px">用户编辑</a-button>-->
          <a-button type="primary" icon="plus" style="margin-top: 16px" @click="handleAddUserRole">添加已有用户</a-button>
