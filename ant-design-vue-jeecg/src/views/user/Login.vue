          ...
          <a-row :gutter="0">
            <a-col :span="14">
              <a-form-item>
                ...
                >
                  <a-icon v-if=" inputCodeContent==verifiedCode " slot="prefix" type="smile" :style="{ color: 'rgba(0,0,0,.25)' }" />
                  <a-icon v-else slot="prefix" type="frown" :style="{ color: 'rgba(0,0,0,.25)' }" />
                </a-input>
              </a-form-item>
            </a-col>
            <a-col :span="10">
              <j-graphic-code ref="jgraphicCodeRef" style="float: right" remote @success="generateCode" />
            </a-col>
          </a-row>
    ...
    >
      ...
      <a-form>
        ...
        >
          ...
          <a-select :class="{'valid-error':validate_status=='error'}" placeholder="请选择登录部门" style="margin-left:10px;width: 80%" @change="departChange">
