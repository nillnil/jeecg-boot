<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :span="6">
            <a-form-item label="报表编码">
              <a-input v-model="queryParam.code" placeholder="请输入报表编码" />
            </a-form-item>
          </a-col>
          <a-col :span="6">
            <a-form-item label="报表名字">
              <a-input v-model="queryParam.name" placeholder="请输入报表名字" />
            </a-form-item>
          </a-col>
    ...
    <!-- 表单区域 -->
    <onlCgreportHead-modal ref="modalForm" @ok="modalFormOk" />
