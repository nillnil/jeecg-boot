<template>
  <a-card :bordered="false" style="height: 100%">
        ...
        <a-row v-if="queryInfo && queryInfo.length>0" :gutter="24">
          <template v-for="(item,index) in queryInfo">
            <template v-if=" item.hidden==='1' ">
              <a-col v-if="item.view=='datetime'" v-show="toggleSearchStatus" :key=" 'query'+index " :md="12" :sm="16">
                <online-query-form-item :query-param="queryParam" :item="item" :dict-options="dictOptions" />
              </a-col>
            ...
            <template v-else>
              <a-col v-if="item.view=='datetime'" :key=" 'query'+index " :md="12" :sm="16">
                <online-query-form-item :query-param="queryParam" :item="item" :dict-options="dictOptions" />
              </a-col>
    ...
    <div class="table-operator">
      ...
      <j-super-query
        ref="superQuery"
        :field-list="superQuery.fieldList"
        :save-code="$route.fullPath"
    ...
    <div>
      ...
      <onl-cgform-auto-modal ref="modal" :code="code" @success="handleFormSuccess" @schema="handleGetSchema" />
