<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="filter" style="margin-left:8px" @click="doEnhanceSql">SQL增强</a-button>
    ...
    <!-- 表单区域 -->
    <onl-cgform-head-modal ref="modalForm" :action-button="false" @ok="modalFormOk" />
