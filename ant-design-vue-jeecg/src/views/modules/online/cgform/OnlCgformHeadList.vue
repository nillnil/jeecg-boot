<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="24">
            <a-form-item label="表类型">
              <j-dict-select-tag v-model="queryParam.tableType" dict-code="cgform_table_type" />
            </a-form-item>
          </a-col>
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="highlight" style="margin-left:8px" @click="doCgformButton">自定义按钮</a-button>
      <a-button type="primary" icon="strikethrough" style="margin-left:8px" @click="doEnhanceJs">JS增强</a-button>
      <a-button v-has="'online:sql'" type="primary" icon="filter" style="margin-left:8px" @click="doEnhanceSql">SQL增强</a-button>
      <a-button type="primary" icon="tool" style="margin-left:8px" @click="doEnhanceJava">Java增强</a-button>
      <a-button type="primary" icon="database" style="margin-left:8px" @click="importOnlineForm">从数据库导入表单</a-button>
      <a-button v-has="'online:goGenerateCode'" type="primary" icon="database" style="margin-left:8px" @click="goGenerateCode">代码生成</a-button>
    ...
    <!-- 表单区域 -->
    <onl-cgform-head-modal ref="modalForm" @ok="modalFormOk" />
    ...
    <enhance-js ref="ehjs" />
    <enhance-sql ref="ehsql" />
    <enhance-java ref="ehjava" />
    <trans-db2-online ref="transd2o" @ok="transOk" />
    <code-generator ref="cg" />

    <onl-cgform-button-list ref="btnList" />
  </a-card>
</template>
