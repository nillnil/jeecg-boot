<template>
  <a-card :bordered="false">
        ...
        <a-row :gutter="24">
          ...
          <a-col :md="6" :sm="8">
            <a-form-item label="模板CODE">
              <a-input v-model="queryParam.templateCode" placeholder="请输入模板CODE" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="8">
            <a-form-item label="模板内容">
              <a-input v-model="queryParam.templateContent" placeholder="请输入模板内容" />
            </a-form-item>
          </a-col>
          <template v-if="toggleSearchStatus">
            <a-col :md="6" :sm="8">
              <a-form-item label="模板标题">
                <a-input v-model="queryParam.templateName" placeholder="请输入模板标题" />
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="8">
              <a-form-item label="模板类型">
                <a-input v-model="queryParam.templateType" placeholder="请输入模板类型" />
              </a-form-item>
            </a-col>
          </template>
          <a-col :md="6" :sm="8">
    ...
    <!-- 表单区域 -->
    <sysMessageTemplate-modal ref="modalForm" @ok="modalFormOk" />
